    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 text-center px-4 py-20">
                ...
                <p
                    className="text-xl md:text-3xl lg:text-4xl text-primary-foreground/90 mb-6 animate-fade-in-up"
                    style={{animationDelay: "0.2s"}}
                >
                    Ты заслуживаешь здорового и сильного тела
                </p>
                <p
                    className="text-lg md:text-2xl text-primary-foreground/80 mb-12 animate-fade-in-up font-semibold"
