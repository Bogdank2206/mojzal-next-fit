            ...
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between h-20">
                    ...
                    <button
                        ...
                        className={`text-2xl md:text-3xl font-extrabold cursor-pointer ${textColorClass}`}
                    >
                        Мой зал
                    </button>
                    ...
                    <nav className="hidden md:flex items-center gap-8">
                        <button
                            ...
                            className={`${textColorClass} hover:text-primary transition-colors font-semibold`}
                        >
                            Тарифы
                        </button>
                        <button
